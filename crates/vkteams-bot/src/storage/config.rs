...
#[cfg(feature = "vector-search")]
fn default_vector_provider() -> String { "pgvector".to_string() }
#[cfg(feature = "vector-search")]
fn default_collection_name() -> String { "vkteams_embeddings".to_string() }
#[cfg(feature = "vector-search")]
...
#[cfg(feature = "ai-embeddings")]
fn default_ollama_host() -> String { "localhost".to_string() }
#[cfg(feature = "ai-embeddings")]
fn default_ollama_port() -> u16 { 11434 }
#[cfg(feature = "ai-embeddings")]
fn default_batch_size() -> usize { 50 }
#[cfg(feature = "ai-embeddings")]
fn default_auto_generate() -> bool { true }

fn default_retention_days() -> u32 { 365 }
fn default_cleanup_interval() -> u32 { 24 }
fn default_processing_batch_size() -> usize { 100 }
fn default_max_memory_events() -> usize { 10000 }
